...
set DESIGN  HadamardPipeline
set SYN_EFF medium
###set MAP_EFF medium
set MAP_EFF high
set DATE [clock format [clock seconds] -format "%b%d-%T"] 
set _OUTPUTS_PATH outputs_pipe#${DATE}
set _REPORTS_PATH reports_pipe#${DATE}
set _LOG_PATH logs_pipe#${DATE}
...
read_vcd -static -vcd_module pipe -module $DESIGN pipe.vcd
