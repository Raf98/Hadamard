...
set DESIGN  HadamardPipeline1SamplePerCycle
set SYN_EFF medium
###set MAP_EFF medium
set MAP_EFF high
set DATE [clock format [clock seconds] -format "%b%d-%T"] 
set _OUTPUTS_PATH outputs_pipe1sample#${DATE}
set _REPORTS_PATH reports_pipe1sample#${DATE}
set _LOG_PATH logs_pipe1sample#${DATE}
...
set_attribute hdl_search_path { ../HadamardPipeline1SamplePerCycle } /
...
read_hdl -vhdl {HadamardPackage.vhd FullAdder.vhd Mux.vhd MuxMulti.vhd RippleCarry.vhd ShiftRight.vhd Register.vhd RegisterBarrier.vhd PingPongBuffer.vhd HadamardPipeline1SamplePerCycle.vhd}
...
read_sdc ../scripts/constraints2.sdc
...
# 400MHz -> 2/(2.5ns) = 0.8
set_attribute lp_default_toggle_rate 0.8 $DESIGN  
...
shell irun -64 -v93 -top worklib.HadamardPipeline1SamplePerCycle_vhd_tst ../HadamardPipeline1SamplePerCycle/*.vhd ../testbenchs/HadamardPipeline1SamplePerCycle_TB.vhd -input ../testbenchs/pipe1sample_vcd.tcl -access +rw   > $_REPORTS_PATH/irun_pipe.log

puts "Reading .vcd file..."
#set_attribute find_takes_multiple_names  true
read_vcd -static -vcd_module pipe1sample -module $DESIGN pipe1sample.vcd
